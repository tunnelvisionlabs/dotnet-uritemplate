namespace Rackspace.Net
{
    ...
    internal sealed class UriTemplatePartQueryContinuationExpansion : UriTemplatePartExpansion
    {
        public UriTemplatePartQueryContinuationExpansion(IEnumerable<VariableReference> variables)
            : base(variables)
        {
        }
        ...
        public override UriTemplatePartType Type
        {
            get
            {
                return UriTemplatePartType.QueryContinuation;
            }
        }
